...
for (x, y, w, h) in face_detect:
    if cnt != 0:
        ...
        cv2.putText(im2,'Cough: 12.4%, Low Risk',(x+w+2, y+line_height), font, font_size,(255,255,255),3,cv2.LINE_AA)
        cv2.putText(im2,'Shortness of Breath: 30.2%, Medium Risk',(x+w+2, y+line_height*2), font, font_size,(255,255,255),3,cv2.LINE_AA)
        ...
        cv2.putText(im2,'Risk Assessment: 15.2%, Low Risk',(x+w+2, y+line_height*7), font, font_size+1,(100,255,100),5,cv2.LINE_AA)
