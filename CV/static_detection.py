...
for (x, y, w, h) in face_detect:
    ...
    cv2.putText(img,'Cough: Mild',(x+w+2, y+line_height), font, 3,(255,255,255),5,cv2.LINE_AA)
    cv2.putText(img,'Shortness of Breath: Moderate',(x+w+2, y+line_height*2), font, 3,(255,255,255),5,cv2.LINE_AA)
    cv2.putText(img,'Temperature: 37.1 C',(x+w+2, y+line_height*3), font, 3,(255,255,255),5,cv2.LINE_AA)
    cv2.putText(img,'Heart Rate: 72 BPM',(x+w+2, y+line_height*4), font, 3,(255,255,255),5,cv2.LINE_AA)
    cv2.putText(img,'Risk Assessment: Moderate',(x+w+2, y+line_height*6), font, 3,(255,255,255),8,cv2.LINE_AA)
